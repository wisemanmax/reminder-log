...
A reminders and task management PWA. Part of the IRONLOG ecosystem.

## Live App

**[https://reminderlog.ironlog.space](https://reminderlog.ironlog.space)**
...
```bash
# 1. Create a new repo on GitHub named: ironlog-reminder
# 2. Push this folder
git init
git add .
git commit -m "initial deploy"
git remote add origin https://github.com/YOUR_USERNAME/ironlog-reminder.git
...
| Type | Host | Value |
|------|------|-------|
| CNAME | `reminderlog` | `YOUR_USERNAME.github.io` |

GitHub Pages auto-provisions HTTPS once DNS propagates (usually < 30 min).

## IRON Rank System

ReminderLog participates in the shared IRONLOG XP/rank system:
